...
// A very simple windows BMP image loader
class BMPImg
 {
  public:
   BMPImg()
...
inline int BMPImg::Load(char* szFilename)
 {
  int iRet;
...
inline int BMPImg::GetFile(char* szFilename)
 {
  using namespace std;
  ifstream fIn;
...
inline int BMPImg::ReadBmpHeader()
 {
  int iInfo;
...
inline int BMPImg::LoadBmpPalette()
 {
  int iIndex;
...
inline void BMPImg::FlipImg(void)
 {
  unsigned char bTemp;
...
inline int BMPImg::GetBPP()
 {
  return iBPP;
 }


inline int BMPImg::GetWidth()
 {
  return iWidth;
 }


inline int BMPImg::GetHeight()
 {
  return iHeight;
 }


inline unsigned char* BMPImg::GetImg()
 {
  return pImage;
 }


inline unsigned char* BMPImg::GetPalette()
 {
  return pPalette;
 }
